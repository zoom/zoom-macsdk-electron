...
return{
  ...
  StartMeeting: function(meetingnum, directshareappwndhandle, participantid, isvideooff, isaudiooff, isdirectsharedesktop){
    var meetingnumber = $.NSString('stringWithUTF8String', String(meetingnum));
  ...
  StartMeeting_APIUSER: function(userid, usertoken, zoomaccesstoken, username, zoomusertype, meetingnumber,
                 vanityid, directshareappwndhandle, participantid, isdirectsharedesktop, isvidoeoff, isaudiooff){
    ...
    var vanityid = $.NSString('stringWithUTF8String', vanityid);
    return meetingServiceObj('startMeetingWithZAK', zoomaccesstokenstring, 'userType', zoomusertype,'userID',useridstring, 'userToken', usertokenstring, 'displayName', displayname, 'meetingNumber', meetingnumberstring,'isDirectShare',isdirectsharedesktop,'sharedApp',directshareappwndhandle,'isVideoOff',isvidoeoff, 'isAuidoOff', isaudiooff, 'vanityID', vanityid);
  
  },

  JoinMeeting: function(meetingnum, vanityid, username, psw, directshareappwndhandle, participantid, webinartoken, isvideooff, isaudiooff, isdirectsharedesktop){
  ...
  JoinMeeting_APIUSER: function(meetingnum, vanityid, username, psw, directshareappwndhandle, toke4enfrocelogin, 
